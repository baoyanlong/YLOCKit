//
//  YLOnboardingContentViewController.m
//  YLOCKit
//
...
@interface YLOnboardingContentViewController ()
...
@implementation YLOnboardingContentViewController
...
- (instancetype)initWithTitle:(NSString *)title body:(NSString *)body image:(UIImage *)image buttonText:(NSString *)buttonText action:(dispatch_block_t)action {
    return [self initWithTitle:title body:body image:image buttonText:buttonText actionBlock:^(YLOnboardingViewController *onboardController) {
        if (action) {
            action();
        }
    }];
...
- (instancetype)initWithTitle:(NSString *)title body:(NSString *)body videoURL:(NSURL *)videoURL  buttonText:(NSString *)buttonText action:(dispatch_block_t)action {
    return [self initWithTitle:title body:body image:nil videoURL:videoURL buttonText:buttonText actionBlock:^(YLOnboardingViewController *onboardController) {
        if (action) {
            action();
        }
    }];
...
- (instancetype)initWithTitle:(NSString *)title body:(NSString *)body image:(UIImage *)image videoURL:(NSURL *)videoURL buttonText:(NSString *)buttonText actionBlock:(action_callback)actionBlock {
    ...
    self.buttonActionHandler = actionBlock ?: ^(YLOnboardingViewController *controller){};
