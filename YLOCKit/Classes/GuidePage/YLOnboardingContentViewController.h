//
//  YLOnboardingContentViewController.h
//  YLOCKit
//
...
@class YLOnboardingViewController;
@class YLOnboardingContentViewController;

@protocol YLOnboardingContentViewControllerDelegate <NSObject>

@required
- (void)setNextPage:(YLOnboardingContentViewController *)contentVC;
- (void)setCurrentPage:(YLOnboardingContentViewController *)contentVC;
...
typedef void (^action_callback)(YLOnboardingViewController *onboardController);


@interface YLOnboardingContentViewController : UIViewController

@property (nonatomic, weak) YLOnboardingViewController<YLOnboardingContentViewControllerDelegate> *delegate;
