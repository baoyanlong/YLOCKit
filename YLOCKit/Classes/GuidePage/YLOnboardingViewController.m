...
@interface YLOnboardingViewController ()

@property (nonatomic, strong) YLOnboardingContentViewController *currentPage;
@property (nonatomic, strong) YLOnboardingContentViewController *upcomingPage;
...
@implementation YLOnboardingViewController
...
- (void)generateView {
    ...
    // and auto-navigation
    for (YLOnboardingContentViewController *contentVC in self.viewControllers) {
...
- (void)setCurrentPage:(YLOnboardingContentViewController *)currentPage {
    _currentPage = currentPage;
}

- (void)setNextPage:(YLOnboardingContentViewController *)nextPage {
